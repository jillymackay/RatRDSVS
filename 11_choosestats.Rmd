...
Let's use the `chickwts` data to explore this. `chickwts` describes a simple experiment with six different feedtypes and the weights of the chicks fed on them. 
...
chk_g <- glm(weight ~ feed, data = chickwts)
summary(chk_g)
