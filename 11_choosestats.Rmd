...
**I have a . . .**
   ...
   * [Categorical response variable](#cs_rcat)
      ...
      + [And I want to compare it across two groups](#cs_rcat_ecat_g)
      
      + [And I want to predict it with a numerical response](#cs_rcat_enum)
      
    * [Numerical response variable]()
    
      + [And I want to compare it to a historical/known condition or I have only one sample group]()
      
      + [And I want to compare it repeated measures of the same response in one sample group]()
      
      + [And I want to compare it across two groups]()
...
#### Proportion of responses compared across groups (Fishers/Chi^2^ test) {#cs_rcat_ecat_g}
...
tidy(logit) %>% 
  ...
  kable(caption = "Table 11.1: Coefficient table for variables in binary logistic regression predicting hip dysplasia\nfrom inflammation markers in 21 German Shepard Dogs")
