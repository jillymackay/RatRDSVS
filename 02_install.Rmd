...
To download R Studio follow [this link](https://rstudio.com/products/rstudio/download/?utm_source=downloadrstudio&utm_medium=Site&utm_campaign=home-hero-cta).
...
In **Figure 2.1** you will see a view of R Studio as you first open it. There may be some differences, e.g. you will likely have a different R Version number. 



```{r echo = FALSE, fig.width = 4, fig.cap="Figure 2.1: R Studio Overview", fig.align = 'center' }
...
Now your screen should look like **Figure 2.2**. You will have four panes in your window, and each pane can be dragged around or minimised. Note - you want to create a new R Script file, **not** an R Markdown or R Notebook file. We will do that next. 

```{r echo = FALSE, fig.width = 4, fig.cap="Figure 2.2: R Studio Overview with Script File", fig.align = 'center'}
...
On the top left hand side of the R Studio window you can view the untitled R Script file you have just opened (**Figure 2.3**). Here you will see views of your files (mostly R Script files and R Markdown files in this book), and views of your data.

```{r echo = FALSE, fig.width = 4, fig.cap="Figure 2.3: The active file pane", fig.align = 'center'}
...
```{r echo = FALSE, fig.width = 4, fig.cap="Figure 2.4: The console pane", fig.align = 'center'}
...
The Environment is shown in **Figure 2.5**. At the moment, your environment will be empty. We will talk more about what goes here in [the environment section of getting started](#environment).



```{r echo = FALSE, fig.width = 4, fig.cap="Figure 2.5 The environment pane", fig.align = 'center'}
...
The final pane, shown in **Figure 2.6**, has five tabs in it by default. 
...
```{r echo = FALSE, fig.width = 4, fig.cap="Figure 2.6 File, plot, package and help viewer", fig.align = 'center'}
...
Go to `Tools > Global Options` (**Figure 2.7**)



```{r echo = FALSE, fig.width = 4, fig.cap="Figure 2.7 Global options", fig.align = 'center'}

knitr::include_graphics("images/02_install/rstud07.png")

```

And then go to `Appearance > Editor Theme` to play around and find the colour scheme, font, and R Studio Theme you like best (**Figure 3.8**)

```{r echo = FALSE, fig.width = 4, fig.cap="Figure 2.8 Global options, themes", fig.align = 'center'}
