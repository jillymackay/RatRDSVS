...
This time Iw ant you to change two things about the `read_excel` code. 

The file is now saved in a folder inside your working directory called `data`.

And I don't want to load the `readxl` library every time I run this piece of code. Is there a short cut we can use?
